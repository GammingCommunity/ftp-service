...
class FileHelper
{
	 ...
	 * @return FtpServiceResponse
	 */
	public static function store(string $diskName, ?UploadedFile $file, ?array $fileExtensions = null, ?string $fileName = null, int $randomNameLength = null): FtpServiceResponse
	{
		$response = new FtpServiceResponse(FtpServiceResponseStatus::SUCCESSFUL);
